	...
	<main class="main-content">
				...
				<div class="slides">
					<div class="slide is-active">
						...
						<div class="image-container">
							<img
								src="../Images/attraction/slider-1.png"
								alt=""
								class="image"
							/>
						</div>
					...
					<div class="slide">
						...
						<div class="image-container">
							<img
								src="../Images/attraction/slider-2.jpeg"
								alt=""
								class="image"
							/>
						</div>
					...
					<div class="slide">
						<div class="slide-content">
							...
							<div class="caption-border">
								<div class="caption">
									<div class="title">Mountain Spring</div>
									<div class="text">
						...
						<div class="image-container">
							<img
								src="../Images/attraction/slider-3.png"
								alt=""
								class="image"
							/>
						</div>
					...
					<div class="slide">
						<div class="slide-content">
							...
							<div class="caption-border">
								<div class="caption">
									<div class="title">Secret River</div>
									<div class="text">
										<p>Float, swim, and have fun!</p>
									</div>
								</div>
							</div>
						</div>
						<div class="image-container">
							<img
								src="../Images/attraction/slider-4.jpeg"
								alt=""
								class="image"
							/>
						</div>
		...
		<section id="attraction-cards">
			<div class="attraction-title-wrapper">
				<h1 class="attraction-title">What to see at Sonya`s</h1>
			</div>
			<div class="attraction-divider"></div>
			<div class="book-cards">
				<div class="book-card">
					<img src="../Images/attraction/slider-1.png" alt="" />
					<h1>Garden</h1>
					<p>
						Escape to our lush garden oasis filled with vibrant
						flowers and serene pathways. Perfect for nature lovers
						seeking tranquility.
					</p>
					<div class="btn-box">
				...
				<div class="book-card">
					<img src="../Images/attraction/slider-2.jpeg" alt="" />

					<h1>Shops</h1>
					<p>
						Explore unique shops with handmade crafts and stylish
						finds.
					</p>
					<div class="btn-box">
						<a href="#">EXPLORE MORE</a>
				...
				<div class="book-card">
					<img src="../Images/attraction/slider-3.png" alt="" />
					<h1>Mountain Spring</h1>
					<p>
						Unwind in nature's embrace at our mountain spring: pure,
						serene, rejuvenating.
					</p>
					<div class="btn-box">
						<a href="#">EXPLORE MORE</a>
				...
				<div class="book-card">
					<img src="../Images/attraction/slider-4.jpeg" alt="" />
					<h1>Secret River</h1>
					<p>
						Discover our hidden river, a tranquil sanctuary in the
						heart of the forest.
					</p>
					<div class="btn-box">
						<a href="#">EXPLORE MORE</a>
